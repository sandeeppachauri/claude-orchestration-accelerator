#!/usr/bin/env bash
# PostToolUse hook: nudge to update docs/architecture.md, docs/HOWTO.md, or README.md
...
case "$file_path" in
  *.py|*process_registry.yaml|*batch_registry.yaml|*prompts/*.yaml)
    echo "[doc-sync] '$file_path' changed -- review whether docs/architecture.md, docs/HOWTO.md, or README.md need updating to match." >&2
    ;;
esac
