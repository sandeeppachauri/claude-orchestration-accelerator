...
After implementing any change, generate a summary with:
- list of files touched, with a count
- per-file reason (one line per file, why that file was touched)
- high-level summary of what changed and why

Post this at the end of the turn, not as a separate file.
